...
" ovm_sv/src/base/
"-------------------------------------------------------------------------------
" ovm_sv/src/base/ovm_component.svh
...
" ovm_sv/src/base/ovm_config.svh
...
" ovm_sv/src/base/ovm_report_server.svh
...
" ovm_sv/src/base/ovm_factory.svh
...
" ovm_sv/src/base/ovm_object.svh
...
" ovm_sv/src/base/ovm_port_base.svh
...
" ovm_sv/src/base/ovm_printer.svh
...
" ovm_sv/src/base/ovm_registry.svh
...
" ovm_sv/src/base/ovm_report_defines.svh
...
" ovm_sv/src/base/ovm_report_global.svh
...
" ovm_sv/src/base/ovm_report_handler.svh
...
" ovm_sv/src/base/ovm_report_object.svh
...
" ovm_sv/src/base/ovm_transaction.svh
...
" ovm_sv/src/base/ovm_version.svh
syn keyword ovmMethodGlobal      ovm_revision_string

"-------------------------------------------------------------------------------
" ovm_sv/src/base/compatibility/
"-------------------------------------------------------------------------------
" ovm_sv/src/base/compatibility/avm_compatibility.svh
...
" " ovm_sv/src/base/compatibility/base_compatibility.svh
" syn keyword ovmClass             
" syn keyword ovmMethod            
" 
" " ovm_sv/src/base/compatibility/compatibility.svh
" syn keyword ovmClass             
" syn keyword ovmMethod            
" 
" " ovm_sv/src/base/compatibility/urm.svh
" syn keyword ovmClass             
" syn keyword ovmMethod            
" 
" " ovm_sv/src/base/compatibility/urm_compatibility.svh
" syn keyword ovmClass             
" syn keyword ovmMethod            
" 
" " ovm_sv/src/base/compatibility/urm_macro_compatibility.svh
" syn keyword ovmClass             
" syn keyword ovmMethod            
" 
" " ovm_sv/src/base/compatibility/urm_message.svh
" syn keyword ovmClass             
" syn keyword ovmMethod            
" 
" " ovm_sv/src/base/compatibility/urm_message_compatibility.svh
" syn keyword ovmClass             
" syn keyword ovmMethod            
" 
" " ovm_sv/src/base/compatibility/urm_message_defines.svh
" syn keyword ovmClass             
" syn keyword ovmMethod            
" 
" " ovm_sv/src/base/compatibility/urm_meth_compatibility.svh
" syn keyword ovmClass             
" syn keyword ovmMethod            
" 
" " ovm_sv/src/base/compatibility/urm_port_compatibility.svh
" syn keyword ovmClass             
" syn keyword ovmMethod            
" 
" " ovm_sv/src/base/compatibility/urm_type_compatibility.svh
" syn keyword ovmClass             
" syn keyword ovmMethod            

"-------------------------------------------------------------------------------
" ovm_sv/src/methodology/
"-------------------------------------------------------------------------------
" ovm_sv/src/methodology/methodology.svh
...
" ovm_sv/src/methodology/methodology_noparm.svh

" ovm_sv/src/methodology/ovm_agent.svh
syn keyword ovmClass             ovm_agent
syn keyword ovmMethod            run

" ovm_sv/src/methodology/ovm_algorithmic_comparator.svh
syn keyword ovmClass             ovm_algorithmic_comparator
syn keyword ovmMethod            connect get_type_name write

" ovm_sv/src/methodology/ovm_driver.svh
syn keyword ovmClass             ovm_driver
syn keyword ovmMethod            run

" ovm_sv/src/methodology/ovm_in_order_comparator.svh
...
" ovm_sv/src/methodology/ovm_meth_defines.svh
syn keyword ovmTypeDef           ovm_active_passive_enum

" ovm_sv/src/methodology/ovm_monitor.svh
syn keyword ovmClass             ovm_monitor

" ovm_sv/src/methodology/ovm_pair.svh
...
" ovm_sv/src/methodology/ovm_policies.svh
...
" ovm_sv/src/methodology/ovm_push_driver.svh
syn keyword ovmClass             ovm_push_driver
syn keyword ovmMethod            build check_port_connections end_of_elaboration

" ovm_sv/src/methodology/ovm_random_stimulus.svh
syn keyword ovmClass             ovm_random_stimulus
syn keyword ovmMethod            generate_stimulus get_type_name stop_stimulus_generation

" ovm_sv/src/methodology/ovm_scoreboard.svh
syn keyword ovmClass             ovm_scoreboard
syn keyword ovmMethod            run

" ovm_sv/src/methodology/ovm_subscriber.svh
syn keyword ovmClass             ovm_subscriber
syn keyword ovmMethod            write

" ovm_sv/src/methodology/ovm_test.svh
syn keyword ovmClass             ovm_test
syn keyword ovmMethod            run

"-------------------------------------------------------------------------------
" ovm_sv/src/methodology/layered_stimulus/
"-------------------------------------------------------------------------------
" ovm_sv/src/methodology/layered_stimulus/ovm_layered_stimulus.svh

" ovm_sv/src/methodology/layered_stimulus/ovm_scenario.svh
...
" ovm_sv/src/methodology/layered_stimulus/ovm_scenario_controller.svh
syn keyword ovmClass             ovm_scenario_controller
syn keyword ovmMethod            apply apply_request apply_send

" ovm_sv/src/methodology/layered_stimulus/ovm_scenario_driver.svh
...
"-------------------------------------------------------------------------------
" ovm_sv/src/methodology/sequences/
"-------------------------------------------------------------------------------
" ovm_sv/src/methodology/sequences/ovm_push_sequencer.svh
syn keyword ovmClass             ovm_push_sequencer
syn keyword ovmMethod            run

" ovm_sv/src/methodology/sequences/ovm_req_rsp_sequence.svh
...
" ovm_sv/src/methodology/sequences/ovm_sequence_base.svh
...
" ovm_sv/src/methodology/sequences/ovm_sequence_builtin.svh
...
" ovm_sv/src/methodology/sequences/ovm_sequence_item.svh
...
" ovm_sv/src/methodology/sequences/ovm_sequencer.svh
...
" ovm_sv/src/methodology/sequences/ovm_sequencer_analysis_fifo.svh
syn keyword ovmClass              sequencer_analysis_fifo
syn keyword ovmMethod             write

" ovm_sv/src/methodology/sequences/ovm_sequencer_base.svh
...
" ovm_sv/src/methodology/sequences/ovm_sequencer_param_base.svh
...
" ovm_sv/src/ovm_tlm
"-------------------------------------------------------------------------------
" ovm_sv/src/ovm_tlm/ovm_exports.svh
...
" ovm_sv/src/ovm_tlm/ovm_imps.svh
...
" ovm_sv/src/ovm_tlm/ovm_ports.svh
...
" ovm_sv/src/ovm_tlm/sqr_connections.svh
...
" ovm_sv/src/ovm_tlm/sqr_ifs.svh
...
" ovm_sv/src/ovm_tlm/ovm_tlm.svh

" ovm_sv/src/ovm_tlm/ovm_tlm_fifo_base.svh
syn keyword ovmClass             ovm_tlm_event
syn keyword ovmClass             ovm_tlm_fifo_base
...
" ovm_sv/src/ovm_tlm/ovm_tlm_fifos.svh
syn keyword ovmClass             ovm_tlm_fifo
...
syn keyword ovmClass             ovm_tlm_analysis_fifo
syn keyword ovmMethod            get_type_name write

" ovm_sv/src/ovm_tlm/ovm_tlm_ifs.svh
syn keyword ovmClass             ovm_tlm_if_base
...
" ovm_sv/src/ovm_tlm/ovm_tlm_imps.svh

" ovm_sv/src/ovm_tlm/ovm_tlm_req_rsp.svh
syn keyword ovmClass             ovm_tlm_req_rsp_channel
syn keyword ovmMethod            create create_aliased_exports connect get_type_name
syn keyword ovmClass             ovm_tlm_transport_channel
